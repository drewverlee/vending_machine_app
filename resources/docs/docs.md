...
The `home-routes` handler in the `vending-machine-app.routes.home` namespace
...
The `home-page` function will in turn call the `vending-machine-app.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/vending_machine_app/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `vending-machine-app.handler` namespace:
...
Request middleware functions are located under the `vending_machine_app.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `vending-machine-app.dev-middleware` namespace found in
